...
export default function TopUpItem(props: TopUpItemProps) {
  ...
  const rootImg = process.env.NEXT_PUBLIC_IMAGE

  if (type === 'desktop') {
    return <div className="pb-50 d-md-block d-none">
      <h2 className="text-4xl fw-bold color-palette-1 text-start mb-10 mt-10">{data.name}</h2>
  ...
  return (
    <div className="row align-items-center">
      <div className="col-md-12 col-4">
        <Image src={`${rootImg}/${data.thumbnail}`} width={280} height={380} className="img-fluid" alt="" />
      </div>
