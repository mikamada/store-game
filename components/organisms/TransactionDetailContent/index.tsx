          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
                ...
                <div className="game-checkout d-flex flex-row align-items-center">
                  <div className="pe-4">
                    <div className="cropped">
                      <img src="/assets/img/Thumbnail-3.png" width="200" height="130"
              ...
              <div className="purchase pt-30">
                ...
                <Row label='Price' value={formatCurrency(42228000)} />
                <Row label='Tax (10%)' value={formatCurrency(4228000)} />
                <Row label='Total' value={formatCurrency(55000600)} className='color-palette-4' />
              </div>
              <div className="payment pt-10 pb-10">
                ...
                <Row label='Bank Account Name' value="PT Store Game Indonesia" />
                <Row label='Bank Number' value="1800 - 9090 - 2021" />
              </div>
              <div className="d-md-block d-flex flex-column w-100">
                <Link className="btn btn-whatsapp rounded-pill fw-medium text-white border-0 text-lg" href="#"
                  role="button">WhatsApp ke Admin</Link>
              </div>
            </section>
          </div>
        </div>
