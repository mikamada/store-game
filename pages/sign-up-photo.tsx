        ...
        <form action="">
          <div className="form-input d-md-block d-flex flex-column">
              ...
              <div className="mb-20">
                <div className="image-upload text-center">
                  <label htmlFor="avatar">
                    <Image src={"/assets/icon/upload.svg"} width={120} height={120} alt="upload icon" />
                  </label>
            ...
            <div className="button-group d-flex flex-column mx-auto">
              <Link className="btn btn-create fw-medium text-lg text-white rounded-pill mb-16"
                href="./sign-up-success" role="button">Create My Account</Link>
