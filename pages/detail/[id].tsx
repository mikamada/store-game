...
import { detailVoucher } from "../../services/player"
...
export default function Detail() {
  ...
  const getDetailGame = useCallback(async (id: string) => {
    const data = await detailVoucher(id);
    console.log(data)
  ...
  useEffect(() => {
    if (isReady) {
      getDetailGame(query.id as string);
    }
  }, [isReady])
