      ...
      <section className="sidebar">
        <div className="content pt-50 pb-30 ps-30">
          <div className="user text-center pb-50 pe-30">
            <img src="/assets/img/avatar-1.png" width="90" height="90" className="img-fluid mb-20" />
              ...
              <table className="table table-borderless">
                ...
                <tbody>
                  <tr className="align-middle">
                    <th scope="row">
                      <img className="float-start me-3 mb-lg-0 mb-3" src="/assets/img/overview-1.png"
                  ...
                  <tr className="align-middle text-center">
                    <th scope="row">
                      <img className="float-start me-3 mb-lg-0 mb-3" src="/assets/img/overview-2.png"
                        width="80" height="60" alt="" />
                      <div className="game-title-header">
                  ...
                  <tr className="align-middle text-center">
                    <th scope="row">
                      <img className="float-start me-3 mb-lg-0 mb-3" src="/assets/img/overview-3.png"
                        width="80" height="60" alt="" />
                      <div className="game-title-header">
                  ...
                  <tr className="align-middle text-center">
                    <th scope="row">
                      <img className="float-start me-3 mb-lg-0 mb-3" src="/assets/img/overview-4.png"
                        width="80" height="60" alt="" />
                      <div className="game-title-header">
